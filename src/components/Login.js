...
function Login() {
  ...
  const handleLogin = async () => {
    ...
    const res = await fetch("https://password-reset-9wl5.onrender.com/user/login", {
      method: "POST",
  ...
  return (
    <div className="container login-div">
      ...
      />
      <Link to="/forgot-password" className="mt-4 cursor-pointer">Forgot Password ?</Link>
      {err ? (
